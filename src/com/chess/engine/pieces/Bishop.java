...
public class Bishop extends Piece { //subclass
    ...
    public Collection<Move> calculateLegalMoves(final Board board) {
        ...
        for (final int candidateCoordinatesOffset: CANDIDATE_MOVE_VECTOR_COORDINATES) {
            ...
            while(BoardUtils.isValidTileCoordinates(candidateDestinationCoordinates)){
                if(isFirstColumnExclusion(candidateDestinationCoordinates, candidateCoordinatesOffset) ||
                isEighthColumnExclusion(candidateDestinationCoordinates, candidateCoordinatesOffset)) {
                    break;
                }
